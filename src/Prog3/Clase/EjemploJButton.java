...
public class EjemploJButton extends JFrame {
    ...
    public EjemploJButton() {
        ...
        mainButton.setIcon(new ImageIcon(Objects.requireNonNull(getClass().getResource("/coffee-icon.png"))));
        mainButton.setDisabledIcon(new ImageIcon(Objects.requireNonNull(getClass().getResource("/pingus-icon.png"))));
