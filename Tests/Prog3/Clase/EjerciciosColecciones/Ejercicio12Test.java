...
public class Ejercicio12Test {
    ...
    public void testEliminarDuplicados() {
        ...
        productos = Ejercicio12.eliminarDuplicados(productos);

        assertEquals(5, productos.get(0).getId());
        assertEquals(1, productos.get(1).getId());
        assertEquals(3, productos.get(2).getId());
        assertEquals(10, productos.get(3).getId());
        assertEquals(7, productos.get(4).getId());
    }
}
